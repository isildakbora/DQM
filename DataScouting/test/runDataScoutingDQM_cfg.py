...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(      #'/store/data/Run2012B/DataScouting/RAW/v1/000/194/533/FADCCE72-C5A2-E111-825D-003048D2BBF0.root',
...
process.schedule = cms.Schedule(process.testmodule_step)
#,process.dqmsave_step,process.DQMoutput_step)
